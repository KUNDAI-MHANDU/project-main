...
$catogory = 'Water And Electricity';
$problems = '';
if (isset($_POST["W_E"])){

    if (isset($_POST["LeakngPipe"])){

        $problems .= $_POST["LeakngPipe"].':';
    }
    if (isset($_POST["LooseCable"])){

        $problems .= $_POST["LooseCable"].':';
    }
    if (isset($_POST["DeadOurlets"])){

        $problems .= $_POST["DeadOurlets"].':';
    }
    if (isset($_POST["BrokenTaps"])){

        $problems .= $_POST["BrokenTaps"].':';
    }
    if (isset($_POST["ElectricitySurge"])){

        $problems .= $_POST["ElectricitySurge"].':';
    }

    $details = sanitizeInput($_POST["ProblemDescription"]);
    $description = $problems.$details;
                ...
                <div class="table-data">
                    <div class="order">
                        ...
                        <section class="possible"> 
                            <table>
                                <tr>
                                    <td> <label for="LeakngPipe"> Leaking Pipe</label></td>
                                    <td> <input type="checkbox" name="LeakngPipe" value="Leaking Pipe"></td>
                                </tr>
                                <tr>
                                    <td><label for="LooseCable"> Loose Cable</label></td>
                                    <td><input type="checkbox" name="LooseCable" value="Loose Cable"></td>
                                </tr>
            
                                <tr>
                                        <td><label for="DeadOurlets"> Dead Outlets</label></td>
                                        <td><input type="checkbox" name="DeadOurlets" value="Dead Outlets"></td>
                                </tr>
                
                                <tr>
                                        <td><label for="BrokenTaps"> Broken Taps</label></td>
                                        <td><input type="checkbox" name="BrokenTaps" value="Broken Taps"></td>
                                </tr>
                                
                                <tr>
                                        <td><label for="ElectricitySurge"> Electricity Surge</label></td>
                                        <td><input type="checkbox" name="ElectricitySurge" value="Electricity Surge"></td>
                                </tr>
                            </table>
                        </section>
                    </div>
